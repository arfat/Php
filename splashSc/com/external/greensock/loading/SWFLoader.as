 ...
 **/
package com.external.greensock.loading {
	import com.external.greensock.events.LoaderEvent;
	import com.external.greensock.loading.core.DisplayObjectLoader;
	import com.external.greensock.loading.core.LoaderCore;
	...
	[Event(name="scriptAccessDenied", 	type="com.external.greensock.events.LoaderEvent")]
	/** Dispatched when the loader's <code>httpStatus</code> value changes. **/
	[Event(name="httpStatus", 			type="com.external.greensock.events.LoaderEvent")]
	/** Dispatched when the loader experiences a SECURITY_ERROR while loading or auditing its size. **/
	[Event(name="securityError", 		type="com.external.greensock.events.LoaderEvent")]
/**
 ...
 * 		<li><strong> scaleMode : String </strong> - When a <code>width</code> and <code>height</code> are defined, the <code>scaleMode</code> controls how the loaded swf will be scaled to fit the area. The following values are recognized (you may use the <code>com.external.greensock.layout.ScaleMode</code> constants if you prefer):
 * 			<ul>
 ...
 * 			</ul></li>
 * 		<li><strong> hAlign : String </strong> - When a <code>width</code> and <code>height</code> are defined, the <code>hAlign</code> determines how the swf is horizontally aligned within that area. The following values are recognized (you may use the <code>com.external.greensock.layout.AlignMode</code> constants if you prefer):
 * 			<ul>
 ...
 * 			</ul></li>
 * 		<li><strong> vAlign : String </strong> - When a <code>width</code> and <code>height</code> are defined, the <code>vAlign</code> determines how the swf is vertically aligned within that area. The following values are recognized (you may use the <code>com.external.greensock.layout.AlignMode</code> constants if you prefer):
 * 			<ul>
 ...
 * 		<li><strong> onHTTPStatus : Function</strong> - A handler function for <code>LoaderEvent.HTTP_STATUS</code> events. Make sure your onHTTPStatus function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.external.greensock.events.LoaderEvent</code>). You can determine the httpStatus code using the LoaderEvent's <code>target.httpStatus</code> (LoaderItems keep track of their <code>httpStatus</code> when possible, although certain environments prevent Flash from getting httpStatus information).</li>
 ...
 * 
 * <code>content</code> data type: <strong><code>com.external.greensock.loading.display.ContentDisplay</code></strong> (a Sprite). 
 ...
 * @example Example AS3 code:<listing version="3.0">
 ...
 import com.external.greensock.loading.~~;
 ...
 function initHandler(event:LoaderEvent):void {
	 ...
	 //find the "com.external.greensock.TweenLite" class that's inside the subloaded swf
	 var tweenClass:Class = loader.getClass("com.external.greensock.TweenLite");
 }
 ...
 * 
 * @see com.external.greensock.loading.data.SWFLoaderVars
 * 
 ...
 */	
	public class SWFLoader extends DisplayObjectLoader {
		 ...
		 * class by name. For example, if the swf contains a class named "com.external.greensock.TweenLite", you can get a 
		 * reference to that class like:<br /><br /><code>
		 * 
		 * var tweenLite:Class = loader.getClass("com.external.greensock.TweenLite");<br />
		 * //then you can create an instance of TweenLite like:<br />
		 * var tween:Object = new tweenLite(mc, 1, {x:100});<br /></code>
		 * 
		 * @param className The full name of the class, like "com.external.greensock.TweenLite".
