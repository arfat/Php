 ...
 **/
package com.external.greensock.loading.core {
	import com.external.greensock.events.LoaderEvent;
	import com.external.greensock.loading.LoaderMax;
	...
	[Event(name="open", 	type="com.external.greensock.events.LoaderEvent")]
	/** Dispatched each time the <code>bytesLoaded</code> value changes while loading (indicating progress). **/
	[Event(name="progress", type="com.external.greensock.events.LoaderEvent")]
	/** Dispatched when the loader completes. **/
	[Event(name="complete", type="com.external.greensock.events.LoaderEvent")]
	...
	[Event(name="cancel", 	type="com.external.greensock.events.LoaderEvent")]
	/** Dispatched when the loader fails. **/
	[Event(name="fail", 	type="com.external.greensock.events.LoaderEvent")]
	/** Dispatched when the loader experiences some type of error, like a SECURITY_ERROR or IO_ERROR. **/
	[Event(name="error", 	type="com.external.greensock.events.LoaderEvent")]
	...
	[Event(name="unload", 	type="com.external.greensock.events.LoaderEvent")]
/**
