...
package com.external.greensock.loading {
	...
	import com.external.greensock.loading.display.ContentDisplay;
 ...
 * 		<li><strong> scaleMode : String </strong> - When a <code>width</code> and <code>height</code> are defined, the <code>scaleMode</code> controls how the video will be scaled to fit the area. The following values are recognized (you may use the <code>com.external.greensock.layout.ScaleMode</code> constants if you prefer):
 * 			<ul>
 ...
 * 			</ul></li>
 * 		<li><strong> hAlign : String </strong> - When a <code>width</code> and <code>height</code> are defined, the <code>hAlign</code> determines how the video is horizontally aligned within that area. The following values are recognized (you may use the <code>com.external.greensock.layout.AlignMode</code> constants if you prefer):
 * 			<ul>
 ...
 * 			</ul></li>
 * 		<li><strong> vAlign : String </strong> - When a <code>width</code> and <code>height</code> are defined, the <code>vAlign</code> determines how the video is vertically aligned within that area. The following values are recognized (you may use the <code>com.external.greensock.layout.AlignMode</code> constants if you prefer):
 * 			<ul>
 ...
 * 
 * @see com.external.greensock.loading.data.VideoLoaderVars
 * 
		...
		public function VideoLoader(urlOrRequest:*, vars:Object=null) {
			...
			if (LoaderMax.contentDisplayClass is Class) {
				...
				if (!_sprite.hasOwnProperty("rawContent")) {
					throw new Error("LoaderMax.contentDisplayClass must be set to a class with a 'rawContent' property, like com.external.greensock.loading.display.ContentDisplay");
				}
			} else {
