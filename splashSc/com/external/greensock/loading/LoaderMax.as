...
package com.external.greensock.loading {
	...
	import com.external.greensock.loading.core.LoaderItem;
	...
	[Event(name="ioError", 				type="com.external.greensock.events.LoaderEvent")]
...
import com.external.greensock.events.LoaderEvent;
import com.external.greensock.loading.display.~~;
 ...
 * 		<li><strong> onHTTPStatus : Function</strong> - A handler function for <code>LoaderEvent.HTTP_STATUS</code> events. Make sure your onHTTPStatus function accepts a single parameter of type <code>LoaderEvent</code> (<code>com.external.greensock.events.LoaderEvent</code>).</li>
 ...
 * 
 * @see com.external.greensock.loading.data.LoaderMaxVars
 * 
 ...
 */	
	public class LoaderMax extends LoaderCore {		
		...
		/** The class used by ImageLoaders, SWFLoaders, and VideoLoaders to create the containers into which they'll dump their rawContent - by default it is the <code>com.external.greensock.loading.display.ContentDisplay</code> class but if you're using Flex, it is typically best to change this to <code>com.external.greensock.loading.display.FlexContentDisplay</code>. You only need to do this once, like <br /><code>import com.external.greensock.loading.LoaderMax;<br />import com.external.greensock.loading.display.FlexContentDisplay;<br />LoaderMax.contentDisplayClass = FlexContentDisplay;</code> **/
...
import com.external.greensock.loading.~~;
import com.external.greensock.loading.core.~~;
import com.external.greensock.events.LoaderEvent;
...
//---- STATIC METHODS ----------------------------------------------------------------------------
		 ...
		 * 		<li><strong> VideoLoader </strong> - A <code>com.external.greensock.loading.display.ContentDisplay</code> (a Sprite) which contains the VideoLoader's <code>rawContent</code> (a Video object to which the NetStream was attached).</li>
		 * 		<li><strong> XMLLoader </strong> - XML</li>
		 * 		<li><strong> DataLoader </strong>
		 * 			<ul>
		 * 				<li><code>String</code> if the DataLoader's <code>format</code> vars property is <code>"text"</code> (the default).</li>
