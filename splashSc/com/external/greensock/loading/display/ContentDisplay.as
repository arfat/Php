 ...
 **/
package com.external.greensock.loading.display {
 ...
 * property like <code>myContent.loader.url</code> or <code>(myContent.loader as SWFLoader).getClass("com.external.greensock.TweenLite");</code>
 * <br /><br />
 * 
...
//---- GETTERS / SETTERS -------------------------------------------------------------------------
		 ...
		 * <code>com.external.greensock.layout.ScaleMode</code> constants if you prefer):
		 * <ul>
		 ...
		 * <code>com.external.greensock.layout.AlignMode</code> constants if you prefer):
		 * <ul>
